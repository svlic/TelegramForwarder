...
def load_media_extensions():
    ...
    return ['无扩展名','txt','jpg','png','gif','mp4','mp3','wav','ogg','flac','aac','wma','m4a','m4v','mov','avi','mkv','webm','mpg','mpeg','mpe','mp2','mpc','oga','3gp','3g2','3gpp','3gpp2','amr','awb','caf','m4b','m4p','m4r','opus','spx','vorbis','ac3','dts','dtshd']